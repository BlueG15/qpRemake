...
export type lambda_number_monster = NumToLambda<10>
...
class CallableClass<T = any> extends Function {
    onCall() : T {return undefined as any}
    constructor() {
        super()
        return new Proxy(this, {
            apply(target){
                return target.onCall()
            }
        }) as (() => T) & this
    }
    get T(){
        return this as any as this & (() => T)
    }
}

//Somehow exporting both a const and a type of the same name works
//....Good?
//Another use of this is in core/target-type
//update, I have found out this is intentional design choice of ts
//and not a bug
//good?
export const Callable = CallableClass
export type Callable<T> = CallableClass<T> & (() => T)


// Source - https://stackoverflow.com/q/75350340
// Posted by Yao Zhao
...
export type ExactKeys<
    ...
    cull extends string[] = [],
    P = PopUnion<keyof T>,
    LastKey extends string = P extends string ? P : string
> 
= {} extends T ? cull 
: ExactKeys<Omit<T, LastKey>, [LastKey, ...cull]>