...
type hardCodedColorKey = keyof typeof hardCodedColor
type hardCodedColorValue = (typeof hardCodedColor)[hardCodedColorKey]

class styleData {
    rgb : hardCodedColorValue;
    isBold : boolean;
    isItalic : boolean;
    isInvisible : boolean;
    constructor(
...
type styleID = keyof typeof textStyle 

export default textStyle
export {styleID, styleData, hardCodedColorKey, hardCodedColorValue, hardCodedColor}
