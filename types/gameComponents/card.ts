import { genericCounter, StatusEffect_base } from "../../defaultImplementation/effects/e_status";
import Position from "../generics/position";
import type Effect from "./effect";
import type { dry_card, dry_system } from "../../data/systemRegistry";

import type { Action } from "../../_queenSystem/handler/actionGenrator";
import type { cardData_unified } from "../../data/cardRegistry";
...
class Card {
    ...
    get nonStatusEffectCount() : number {return this.effects.length}
