...
import { Action_class, actionConstructionObj_fixxed, actionFormRegistry } from "../../_queenSystem/handler/actionGenrator";
...
class error extends Action_class<[], never, {}>  {
    ...
    constructor(cardID? : string){
        let o : actionConstructionObj_fixxed = {
            type : actionRegistry.error,
