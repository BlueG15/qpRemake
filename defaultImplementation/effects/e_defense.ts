...
abstract class e_defense_base extends Effect<[]>{
    protected override canRespondAndActivate(c: dry_card, s: dry_system, a: Action): a is Action<"a_deal_damage_card"> {
    ...
    protected override activate(c: dry_card, s: dry_system, a: Action<"a_deal_damage_card">): Action[] {
        return [
            actionConstructorRegistry.a_modify_action("a_deal_damage_card")(s, a)(this.toCause(s, c))({
...
export class e_dmgcap extends e_defense_base {
    ...
    static override getEffData(){
        return {
            base : quickEffectData.defense.num("dmgCap")()
        }
    }
}
...
export class e_dmg_reduction extends e_defense_base {
    ...
    static override getEffData(): { base: effectData; upgrade?: Partial<effectData>; } {
        return {
            base : quickEffectData.defense.num("reduction")()
        }
    }
}
