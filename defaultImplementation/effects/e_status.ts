...
import { actionConstructorRegistry, Action } from "../../_queenSystem/handler/actionGenrator";
...
export class StatusEffect_base extends Effect<[]> {
    ...
    activateOnReProc?(c : dry_card, system : dry_system, a : Action<"a_activate_effect">) : Action[] 
    ...
    override canRespondAndActivate(c: dry_card, system: dry_system, a: Action): boolean {
    ...
    override activate(c: dry_card, system: dry_system, a: Action) {
        let res : Action[] = []
...
export class genericCounter extends StatusEffect_base {
    ...
    static override getEffData(): { base: effectData; upgrade?: Partial<effectData>; } {
        return {
            base : quickEffectData.counter.count(1)()
        }
    }
}
...
export class generic_stat_change_diff extends StatusEffect_base {
    ...
    static override getEffData(): { base: effectData; upgrade?: Partial<effectData>; } {
        return {
            base : quickEffectData.status.num("maxAtk").num("maxHp").num("level")()
        }
    }
}
...
export class e_automate_base extends StatusEffect_base {
    ...
    protected act(c: dry_card, system: dry_system, a: Action<"a_turn_end">): Action[] {return []}
...
export class e_automate_attack extends e_automate_base {
    protected override act(c: dry_card, s: dry_system, a: Action<"a_turn_end">): Action[] {
        return [
