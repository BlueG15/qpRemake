...
exports.getDropFromLootSet = getDropFromLootSet;
exports.getImgUrl = getImgUrl;
exports.checkForDropCode = checkForDropCode;
exports.drops = [
    {
        codeName: "generic",
        displayName: "generic",
...
const availCode = exports.drops.map((d) => d.codeName);
const displayToCode = {};
for (let i = 0; i < availCode.length; i++) {
    displayToCode[availCode[i]] = availCode[i];
}
function getDropFromLootSet(lootSet) {
    return exports.drops.filter((a) => a.codeName === lootSet.setName)[0];
}
function getImgUrl(lootSet) {
    var _a;
    return window.origin + "/cards/" + ((_a = getDropFromLootSet(lootSet)) === null || _a === void 0 ? void 0 : _a.imgId);
}
function checkForDropCode(code) {
    var _a;
    if (!availCode.includes(code)) {
        return (_a = displayToCode[code]) !== null && _a !== void 0 ? _a : null;
    }
    return code;
}
