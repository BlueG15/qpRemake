...
class action {
    ...
    get hasCardTarget() {return this.targetCardID !== undefined}
    get hasActionTarget() {return this.targetActionID !== undefined}
    get hasCause() {return this.causeCardID !== undefined} //dont have cause -> cause is from playerAction
    get fromPlayer() {return this.hasCause}
    get fromCard() {return !this.hasCause}
    get typeID() {return actionRegistry[this.type]}
    ...
    modifyAttr(key : string, newVal : any){
        ...
        if(key == "targetActionID") return this.changeTarget(Number(newVal))
