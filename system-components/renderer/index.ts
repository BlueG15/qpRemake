import type { Action, TargetTypeID } from "../../core";
...
export abstract class qpRenderer {
     ...
     */
    abstract requestInput<T extends TargetTypeID>(inputSet : TargetSpecific<T>[] , phase : TurnPhase, s : LocalizedSystem, a : Action, callback : (input : TargetSpecific<T>) => any) : void;
}
...
export class sampleRenderer extends qpRenderer {
    ...
    override requestInput<T extends TargetTypeID>(inputSet : TargetSpecific<T>[] , phase : TurnPhase, s : LocalizedSystem, a : Action, callback : (input : TargetSpecific<T>) => any) : void {
